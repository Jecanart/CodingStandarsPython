...
class Plane:
    ...
    def sum(self):
        if not self.myclass.valid_this(self.dist) or not self.passanger.valid_number(self) or not self.total_time.is_valid_total_time():
            return -1
        ...
        discount = self.passanger.for_here_discount(self)
